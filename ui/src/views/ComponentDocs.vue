<template>
  <div class="component-docs">
    ...
    <Navbar title="ChatUI 组件文档">
      <template #menu>
        <Search v-model="searchQuery" placeholder="搜索组件..." @search="handleSearch" />
      </template>
      <template #actions>
      ...
      <Sidebar title="组件" :collapsible="false" class="docs-sidebar">
        <div class="component-nav">
          <div v-for="category in categories" :key="category.name" class="nav-category">
            ...
            <div v-for="comp in category.components" :key="comp.key" :class="['nav-item', { active: currentComponent === comp.key }]" @click="selectComponent(comp.key)">
              {{ comp.name }}
            </div>
          </div>
        </div>
      ...
      <div class="docs-main">
        <ScrollView>
          <div class="docs-content">
            <!-- Button 文档 -->
            <DocViewer v-if="currentComponent === 'button'" :content="buttonDoc" :code="getComponentCode('button')">
              <template #demo>
            ...
            <!-- Bubble 文档 -->
            <DocViewer v-else-if="currentComponent === 'bubble'" :content="bubbleDoc" :code="getComponentCode('bubble')">
              <template #demo>
                <DemoSection title="基础用法">
            ...
            <!-- Avatar 文档 -->
            <DocViewer v-else-if="currentComponent === 'avatar'" :content="avatarDoc" :code="getComponentCode('avatar')">
              <template #demo>
            ...
            <div v-else-if="currentComponent" class="component-doc-page">
              ...
              <div class="doc-section">
                ...
                <div class="props-table">
                  <p class="text-gray-600 dark:text-gray-400">详细的 Props 文档正在完善中...</p>
                </div>
              </div>
              ...
              <div class="doc-section">
                ...
                <div class="demo-area">
                  <p class="text-gray-600 dark:text-gray-400">交互式示例正在开发中，请访问 <router-link to="/components" class="text-blue-600 hover:underline">组件展示页面</router-link> 查看实际效果。</p>
                </div>
              </div>
            </div>
            ...
            <div v-else class="welcome-page">
              ...
              <p class="welcome-subtitle">选择左侧组件查看详细文档和实时演示</p>
...
import { Navbar, Sidebar, ScrollView, Search, Button, Flex, Bubble, Avatar } from "@/components/ChatUI";
