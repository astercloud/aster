...
3. ✅ 安装aster：`go get github.com/astercloud/aster`
...
- [基础Agent](https://github.com/astercloud/aster/tree/main/examples/agent)
- [文件系统操作](https://github.com/astercloud/aster/tree/main/examples/filesystem)
- [工作流Agent](https://github.com/astercloud/aster/tree/main/examples/workflow-agents)
- [Session持久化](https://github.com/astercloud/aster/tree/main/examples/session-postgres)
- [MCP集成](https://github.com/astercloud/aster/tree/main/examples/mcp)
- [多Agent协作](https://github.com/astercloud/aster/tree/main/examples/multi-agent)
- [中间件系统](https://github.com/astercloud/aster/tree/main/examples/middleware)
