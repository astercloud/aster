...
aster采用灵感来自[DeepAgents](https://github.com/anthropics/deepagents)的三层可扩展架构，通过清晰的分层和抽象实现高度可扩展性。

## 🏗️ 整体架构

![架构概览](/aster/images/architecture-overview.svg)
...
![中间件洋葱模型](/aster/images/middleware-onion.svg)
...
- [示例代码](https://github.com/astercloud/aster/tree/main/examples)
- [Phase 6C文档](https://github.com/astercloud/aster/blob/main/docs/PHASE6C_MIDDLEWARE_INTEGRATION.md)
