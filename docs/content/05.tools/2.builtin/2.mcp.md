...
[Model Context Protocol (MCP)](https://modelcontextprotocol.io) 是一种标准协议，让 Agent 能够连接到外部工具服务器。aster 提供了完整的 MCP 集成支持。

[查看完整代码 →](https://github.com/astercloud/aster/blob/main/examples/mcp/main.go)
...
- [完整示例代码](https://github.com/astercloud/aster/blob/main/examples/mcp/main.go)
